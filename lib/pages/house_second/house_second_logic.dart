...
class HouseSecondLogic extends GetxController {

  DBHouse dbHouse = Get.find<DBHouse>();

  cleanHouseData() async {
  ...
  aboutHousePrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutHouseUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can record your rental for you"""),
      ],
      context: context,
    );
  }
